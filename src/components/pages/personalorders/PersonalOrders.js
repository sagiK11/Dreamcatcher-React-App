      ...
      >
        <Box>
          <div>
            ...
            <p>
              ולעצב ביחד איתי את לוכד החלומות והסטים הקסומים שתמיד חלמת עליהם
            </p>
            <p className="flow-text">
              <b className="bold">ללא תוספת תשלום!</b>
            </p>
            ...
            <div className="right-align">
              <ul>
                ...
                <li>
                  <p>בטלפון 050-8829551</p>
                </li>
                <li>
                  <a
                    href="mailto:hilash95@gmail.com"
                    style={{ color: "#776464" }}
                  >
                    <p>אימייל - hilash95@gmail.com</p>
                  </a>
                </li>
              </ul>
            </div>
