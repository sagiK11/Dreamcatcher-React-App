...
const ShipToHome = () => {
  return (
    <div>
      <h6 style={boldStyle}>
        משלוח עד לבית - לכל חלקי הארץ פרט לאזור הערבה ואילת.
      </h6>
...
const CollectFromShop = () => {
  return (
    <div>
      ...
      <p>
        סכום דמי המשלוח ע"פ בחירתך יופיעו בתום תהליך ההזמנה וייגבה בעת ביצוע
        התשלום עבורה.
      </p>
    </div>
  );
...
const ReturnPolicy = () => {
  return (
    <div>
      ...
      <p>
        ניתן להחזיר ולקבל זיכוי/החזר כספי עפ"י החוק* בהחזרת המוצר\ים תוך שני ימי
        עסקים לבית העסק בהוד השרון - בתיאום מראש.
      </p>
      <p>
        *החזר כספי - ניכוי של 5% משווי הפריט או בניכוי של 100 ש"ח הזול מביניהם.
      </p>
      <p>
        *זיכוי - יש להחזיר את המוצר לבית העסק בהוד השרון בתיאום מראש ולאחר מכן,
        יישלח לך במייל זיכוי בצורת קופון לרכישה באתר.
      </p>
