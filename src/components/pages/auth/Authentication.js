        ...
        return (
            <AppBar position="static">
                ...
                <TabPanel value={this.state.value} index={0}>
                    <SignIn auth={this.props.auth} authError={this.props.authError}
                        handle={this.handleChange} submit={this.handleSubmit} />
                </TabPanel>
                <TabPanel value={this.state.value} index={1}>
                    <SignUp auth={this.props.auth} authError={this.props.authError}
                        handle={this.handleChange} submit={this.handleSubmit} />
                </TabPanel>
            </AppBar>
        );
    ...
    return (
        <div>
            ...
            <Grid container direction="row" justify="center"
                alignItems="center" className="border" style={{ padding: "2em" }}>
                <Grid item xs={12} sm={12} md={4} lg={4} className="border">
                    <Grid container justify="center" alignItems="center">
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                            <Button id="signup" fullWidth className={classes.button}
                                variant="outlined" onClick={submit}
                                disableElevation>הרשמה</Button>
                        </Grid>
                    </Grid>
                    <Grid item xs={12} sm={12} md={12} lg={12}>
                ...
                <Grid item xs={8} sm={8} md={8} lg={8} style={{ maxWidth: "25em" }}
...
const SignIn = (props) => {
    ...
    return (
        <div>
            ...
            <Grid container direction="row" justify="center" alignItems="center" className="border" style={{ padding: "2em" }}>
                <Grid item xs={12} sm={12} md={4} lg={4} className="border">
                    <Grid container justify="center" alignItems="center" className="border">
                        <Grid item xs={12} sm={12} md={12} lg={12} className={classes.input}>
                            <EmailField handle={handle} />
                        </Grid>
                        <Grid item xs={12} sm={12} md={12} lg={12} className={classes.input}>
                            <PasswordField handle={handle} />
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                            <Button id="signin" fullWidth className={classes.button}
                                variant="outlined" onClick={submit}
                                disableElevation>התחברות</Button>
                        </Grid>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                            {authError ? <AuthenticationError error={authError} /> : null}
                        </Grid>
                ...
                <Grid item md={8} lg={8} style={{ maxWidth: "25em" }} className="hide-on-med-and-down">
                    <img src={image} alt="לוכד חלומות" className={classes.img} />
                </Grid>
            </Grid>
            <Footer />
